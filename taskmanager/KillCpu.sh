# This script sorts the processes on the basis of the CPU Usage
# This script would take the input from the ProcessList generated by SaveFilter.sh

sh SaveFilter.sh

echo -e "User asked to kill the process taking highest Cpu Usage on" `date` >> LOG

sort -n +5 -6 < ProcessList > KillCpu

set `tail -1 < KillCpu`

echo -e "Highest CPU Usage is of the process $8 (PID = $1) created by User : $9\n"
